...
public class BetterGrass
{
    ...
    private static void loadProperties(TextureMap textureMap)
    {
        ...
        spriteGrass = textureMap.registerSprite(ResourceLocation.of("blocks/grass_top"));
        spriteGrassSide = textureMap.registerSprite(ResourceLocation.of("blocks/grass_side"));
        spriteMycelium = textureMap.registerSprite(ResourceLocation.of("blocks/mycelium_top"));
        spritePodzol = textureMap.registerSprite(ResourceLocation.of("blocks/dirt_podzol_top"));
        spriteSnow = textureMap.registerSprite(ResourceLocation.of("blocks/snow"));
        spritesLoaded = true;
        String s = "optifine/bettergrass.properties";

        try
        {
            ResourceLocation resourcelocation = ResourceLocation.of(s);
    ...
    private static TextureAtlasSprite registerSprite(Properties props, String key, String textureDefault, TextureMap textureMap)
    {
        ...
        ResourceLocation resourcelocation = ResourceLocation.of("textures/" + s + ".png");
        ...
        ResourceLocation resourcelocation1 = ResourceLocation.of(s);
