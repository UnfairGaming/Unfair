...
public class RenderSkeleton extends RenderBiped<EntitySkeleton> {
    private static final ResourceLocation skeletonTextures = ResourceLocation.of("textures/entity/skeleton/skeleton.png");
    private static final ResourceLocation witherSkeletonTextures = ResourceLocation.of("textures/entity/skeleton/wither_skeleton.png");
