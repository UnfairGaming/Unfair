...
public class CustomGuiProperties
{
    ...
    private static final ResourceLocation ANVIL_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/anvil.png");
    private static final ResourceLocation BEACON_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/beacon.png");
    private static final ResourceLocation BREWING_STAND_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/brewing_stand.png");
    private static final ResourceLocation CHEST_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/generic_54.png");
    private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/crafting_table.png");
    private static final ResourceLocation HORSE_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/horse.png");
    private static final ResourceLocation DISPENSER_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/dispenser.png");
    private static final ResourceLocation ENCHANTMENT_TABLE_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/enchanting_table.png");
    private static final ResourceLocation FURNACE_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/furnace.png");
    private static final ResourceLocation HOPPER_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/hopper.png");
    private static final ResourceLocation INVENTORY_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/inventory.png");
    private static final ResourceLocation SHULKER_BOX_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/shulker_box.png");
    private static final ResourceLocation VILLAGER_GUI_TEXTURE = ResourceLocation.of("textures/gui/container/villager.png");
    ...
    private static ResourceLocation parseTextureLocation(String str, String basePath)
    {
        ...
        else
        {
            ...
            return ResourceLocation.of(basePath + "/" + s);
        }
    }
    ...
    private static Map<ResourceLocation, ResourceLocation> parseTextureLocations(Properties props, String property, CustomGuiProperties.EnumContainer container, String pathPrefix, String basePath)
    {
        ...
        for (Object o : props.keySet())
        {
            ...
            if (s1.startsWith(s5))
            {
                ...
                ResourceLocation resourcelocation2 = ResourceLocation.of(s3);
