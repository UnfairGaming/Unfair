            ...
            if (chunk == null) {
                if (this.serverChunkGenerator == null) {
                    ...
                    try {
                        ...
                        CrashReport crashreport = CrashReport.makeCrashReport(throwable, "鐢熸垚鏂板尯鍧楁椂鍑虹幇寮傚父");
                        CrashReportCategory crashreportcategory = crashreport.makeCategory("瑕佺敓鎴愮殑鍖哄潡");
