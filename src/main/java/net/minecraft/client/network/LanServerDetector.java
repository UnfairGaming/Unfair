...
public class LanServerDetector {
    ...
    public static class ThreadLanServerFind extends Thread {
        ...
        public ThreadLanServerFind(LanServerDetector.LanServerList p_i1320_1_) throws IOException {
            ...
            this.networkInterface = this.socket.getNetworkInterface();
            this.socket.setSoTimeout(5000);
            this.socket.joinGroup(new InetSocketAddress(this.broadcastAddress, 4445), this.networkInterface);
        }
        ...
        public void run() {
            ...
            try {
                this.socket.leaveGroup(new InetSocketAddress(this.broadcastAddress, 4445), this.networkInterface);
