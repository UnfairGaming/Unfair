...
public class RenderManager {
    ...
    public <T extends Entity> Render<T> getEntityClassRenderObject(Class<? extends Entity> entityClass) {
        ...
        if (render == null && entityClass != Entity.class) {
            ...
            if (superclass != null && Entity.class.isAssignableFrom(superclass)) {
                render = this.getEntityClassRenderObject(superclass.asSubclass(Entity.class));
            }
    ...
    public boolean renderEntityStatic(Entity entity, float partialTicks, boolean hideDebugBox) {
        ...
        boolean restoreRotation = entity instanceof EntityPlayerSP && RotationState.isRotated(1);
    ...
    public boolean doRenderEntity(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean hideDebugBox) {
        if (!entity.isForcedVisible() && entity.isCulled()) {
            ...
            EntityCullingManager.instance.skippedEntities++;
            return false;
        }

        EntityCullingManager.instance.renderedEntities++;
