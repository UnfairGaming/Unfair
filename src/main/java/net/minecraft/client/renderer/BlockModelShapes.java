...
public class BlockModelShapes {
    ...
    private void registerAllBlocks() {
        ...
        this.registerBlockWithStateMapper(Blocks.end_rod, new StateMapperBase() {
            protected ModelResourceLocation getModelResourceLocation(IBlockState state) {
                EnumFacing facing = state.getValue(BlockEndRod.FACING);
                return new ModelResourceLocation("end_rod", "facing=" + facing.getName());
            }
        });
