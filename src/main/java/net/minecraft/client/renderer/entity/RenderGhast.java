...
public class RenderGhast extends RenderLiving<EntityGhast> {
    private static final ResourceLocation ghastTextures = ResourceLocation.of("textures/entity/ghast/ghast.png");
    private static final ResourceLocation ghastShootingTextures = ResourceLocation.of("textures/entity/ghast/ghast_shooting.png");
