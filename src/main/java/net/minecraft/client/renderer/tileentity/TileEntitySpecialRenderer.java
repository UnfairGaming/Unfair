...
public abstract class TileEntitySpecialRenderer<T extends TileEntity> implements IEntityRenderer {
    protected static final ResourceLocation[] DESTROY_STAGES = new ResourceLocation[]{ResourceLocation.of("textures/blocks/destroy_stage_0.png"), ResourceLocation.of("textures/blocks/destroy_stage_1.png"), ResourceLocation.of("textures/blocks/destroy_stage_2.png"), ResourceLocation.of("textures/blocks/destroy_stage_3.png"), ResourceLocation.of("textures/blocks/destroy_stage_4.png"), ResourceLocation.of("textures/blocks/destroy_stage_5.png"), ResourceLocation.of("textures/blocks/destroy_stage_6.png"), ResourceLocation.of("textures/blocks/destroy_stage_7.png"), ResourceLocation.of("textures/blocks/destroy_stage_8.png"), ResourceLocation.of("textures/blocks/destroy_stage_9.png")};
