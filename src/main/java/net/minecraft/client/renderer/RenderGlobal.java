...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    ...
    private static final ResourceLocation locationMoonPhasesPng = ResourceLocation.of("textures/environment/moon_phases.png");
    private static final ResourceLocation locationSunPng = ResourceLocation.of("textures/environment/sun.png");
    ...
    public RenderGlobal(Minecraft mcIn) {
        ...
        synchronized (GlStateManager.RENDER_THREAD_LOCK) {
            this.generateStars();
            this.generateSky();
            this.generateSky2();
        }
    ...
    public void makeEntityOutlineShader() {
        if (OpenGlHelper.shadersSupported) {
            ...
            ResourceLocation resourcelocation = ResourceLocation.of("shaders/post/entity_outline.json");
    ...
    public void playRecord(String recordName, BlockPos blockPosIn) {
        ...
        if (recordName != null) {
            ...
            PositionedSoundRecord positionedsoundrecord = PositionedSoundRecord.create(ResourceLocation.of(recordName), (float) blockPosIn.getX(), (float) blockPosIn.getY(), (float) blockPosIn.getZ());
        ...
        switch (sfxType) {
            ...
            case 2001:
                ...
                if (block.getMaterial() != Material.air) {
                    this.mc.getSoundHandler().playSound(new PositionedSoundRecord(ResourceLocation.of(block.stepSound.getBreakSound()), (block.stepSound.getVolume() + 1.0F) / 2.0F, block.stepSound.getFrequency() * 0.8F, (float) blockPosIn.getX() + 0.5F, (float) blockPosIn.getY() + 0.5F, (float) blockPosIn.getZ() + 0.5F));
                }
