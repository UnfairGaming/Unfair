...
{
    private transient LongHashMap.Entry<V>[] hashArray = createEntryArray(4096);
    ...
    private void resizeTable(int p_76153_1_)
    {
        ...
        {
            LongHashMap.Entry<V>[] entry1 = createEntryArray(p_76153_1_);
    ...
    private static <V> LongHashMap.Entry<V>[] createEntryArray(int size)
    {
        return (LongHashMap.Entry<V>[])new LongHashMap.Entry[size];
    }
}
