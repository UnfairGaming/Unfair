...
public class DefaultPlayerSkin
{
    ...
    private static final ResourceLocation TEXTURE_STEVE = ResourceLocation.of("textures/entity/steve.png");

    /** The default skin for the Alex model. */
    private static final ResourceLocation TEXTURE_ALEX = ResourceLocation.of("textures/entity/alex.png");
