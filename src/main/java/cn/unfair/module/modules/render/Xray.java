...
public class Xray extends Module {
    ...
    public final BooleanProperty cavesOnly = new BooleanProperty("CavesOnly", true);
    public final IntProperty caveRadius = new IntProperty("CavesRadius", 2, 1, 2);
    public final BooleanProperty diamonds = new BooleanProperty("Diamonds", true);
    public final BooleanProperty diamondTracers = new BooleanProperty("DiamondsTracers", true);
    public final BooleanProperty gold = new BooleanProperty("Gold", true);
    public final BooleanProperty goldTracers = new BooleanProperty("GoldTracers", true);
    public final BooleanProperty iron = new BooleanProperty("Iron", false);
    public final BooleanProperty ironTracers = new BooleanProperty("IronTracers", false);
    public final BooleanProperty coal = new BooleanProperty("Coal", false);
    public final BooleanProperty coalTracers = new BooleanProperty("CoalTracers", false);
    public final BooleanProperty redstone = new BooleanProperty("Redstone", false);
    public final BooleanProperty redStoneTracers = new BooleanProperty("RedstoneTracers", false);
    public final BooleanProperty lapis = new BooleanProperty("Lapis", false);
    public final BooleanProperty lapisTracers = new BooleanProperty("LapisTracers", false);
    public final BooleanProperty emeralds = new BooleanProperty("Emeralds", false);
    public final BooleanProperty emeraldsTracers = new BooleanProperty("EmeraldsTracers", false);
    public final BooleanProperty spawners = new BooleanProperty("Spawners", false);
    public final BooleanProperty spawnerTracers = new BooleanProperty("SpawnersTracers", false);
    public final BooleanProperty canes = new BooleanProperty("Canes", false);
    public final BooleanProperty canesTracers = new BooleanProperty("CanesTracers", false);
    public final BooleanProperty warts = new BooleanProperty("Warts", false);
    public final BooleanProperty wartsTracers = new BooleanProperty("WartsTracers", false);
