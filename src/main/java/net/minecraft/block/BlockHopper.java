...
public class BlockHopper extends BlockContainer {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        if (ViaProtocol.newerThanOrEqualTo1_13()) {
            ...
            switch (facing) {
                case DOWN:
                    addBox(pos, mask, list, 6, 0, 6, 10, 4, 10);
                    break;
                case EAST:
                    addBox(pos, mask, list, 12, 4, 6, 16, 8, 10);
                    break;
                case NORTH:
                    addBox(pos, mask, list, 6, 4, 0, 10, 8, 4);
                    break;
                case SOUTH:
                    addBox(pos, mask, list, 6, 4, 12, 10, 8, 16);
                    break;
                case WEST:
                    addBox(pos, mask, list, 0, 4, 6, 4, 8, 10);
                    break;
            }
