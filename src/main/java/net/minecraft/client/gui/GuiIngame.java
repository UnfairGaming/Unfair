...
public class GuiIngame extends Gui {
    private static final ResourceLocation vignetteTexPath = ResourceLocation.of("textures/misc/vignette.png");
    private static final ResourceLocation widgetsTexPath = ResourceLocation.of("textures/gui/widgets.png");
    private static final ResourceLocation pumpkinBlurTexPath = ResourceLocation.of("textures/misc/pumpkinblur.png");
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (this.recordPlayingUpFor > 0) {
            ...
            if (l1 > 8) {
                ...
                this.getFontRenderer().drawString(this.recordPlaying, (float) -this.getFontRenderer().getStringWidth(this.recordPlaying) / 2, -4, l + (l1 << 24 & -16777216));
                GlStateManager.disableBlend();
    ...
    public void renderExpBar(ScaledResolution scaledRes, int x) {
        ...
        int experienceLevel = this.mc.thePlayer.experienceLevel;
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        for (Score score1 : collection) {
            ...
            if (j == collection.size()) {
                ...
                this.getFontRenderer().drawString(s3, l1 + (float) i / 2 - (float) this.getFontRenderer().getStringWidth(s3) / 2, k - this.getFontRenderer().FONT_HEIGHT, 553648127);
            }
        }
    }
    ...
    public void updateTick() {
        ...
        if (this.mc.thePlayer != null) {
            ItemStack itemstack = this.getHighlightedItemStack();
    ...
    private ItemStack getHighlightedItemStack() {
        if (Unfair.moduleManager != null) {
