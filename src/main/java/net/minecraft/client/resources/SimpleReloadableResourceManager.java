        ...
        for (IResourceManagerReloadListener listener : this.reloadListeners) {
            if (Minecraft.getMinecraft() != null) {
                if (Minecraft.getMinecraft().currentScreen instanceof GuiLanguage) {
                    if (listener instanceof FontRenderer ||
                            listener instanceof TextureManager ||
                            listener instanceof SoundHandler ||
                            listener instanceof GrassColorReloadListener ||
                            listener instanceof FoliageColorReloadListener ||
                            listener instanceof ModelManager ||
                            listener instanceof RenderItem ||
                            listener instanceof EntityRenderer ||
                            listener instanceof BlockRendererDispatcher ||
