...
public class CustomItemProperties
{
    ...
    private ResourceLocation getTextureLocation(String texName)
    {
        ...
        {
            ResourceLocation resourcelocation = ResourceLocation.of(texName);
            ...
            String s2 = s1 + ".png";
            ResourceLocation resourcelocation1 = ResourceLocation.of(s, s2);
    ...
    private ResourceLocation getSpriteLocation(ResourceLocation resLoc)
    {
        ...
        ResourceLocation resourcelocation = ResourceLocation.of(resLoc.getResourceDomain(), s);
    ...
    private static IBakedModel bakeModel(TextureMap textureMap, ModelBlock modelBlockIn, boolean useTint)
    {
        ...
        TextureAtlasSprite textureatlassprite = textureMap.getAtlasSprite((ResourceLocation.of(s)).toString());
        ...
        for (BlockPart blockpart : modelBlockIn.getElements())
        {
            for (EnumFacing enumfacing : blockpart.mapFaces.keySet())
            {
                ...
                TextureAtlasSprite textureatlassprite1 = textureMap.getAtlasSprite((ResourceLocation.of(s1)).toString());
    ...
    {
        return ResourceLocation.of(modelName);
    }
}
