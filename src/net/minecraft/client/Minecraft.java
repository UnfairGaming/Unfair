...
import cn.unfair.events.HitBlockEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() {
        ...
        this.fontRendererObj = new FontRenderer(this.gameSettings, ResourceLocation.of("textures/font/ascii.png"), this.renderEngine, false);
        ...
        this.standardGalacticFontRenderer = new FontRenderer(this.gameSettings, ResourceLocation.of("textures/font/ascii_sga.png"), this.renderEngine, false);
        ...
        EntityCullingManager.instance.onInitialize();
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                this.setKeyBindStateAndFireEvent(i - 100, Mouse.getEventButtonState());
                ...
                if (i1 <= 200L) {
                    ...
                    if (j != 0) {
                        if (this.thePlayer.isSpectator()) {
                            ...
                            this.changeCurrentItemWithEvent(this.thePlayer.inventory, j);
                        }
                    }
            ...
            while (Keyboard.next()) {
                ...
                this.setKeyBindStateAndFireEvent(k, Keyboard.getEventKeyState());
        ...
        EntityCullingManager.instance.clientTick();

        if (callTickEvents && this.theWorld != null && this.thePlayer != null) {
            EventManager.call(new TickEvent(EventType.POST));
        }
    }

    private void setKeyBindStateAndFireEvent(int keyCode, boolean pressed) {
    ...
    private void changeCurrentItemWithEvent(InventoryPlayer inventoryPlayer, int slot) {
    ...
    public void setRightClickDelayTimer(int rightClickDelayTimerIn) {
        this.rightClickDelayTimer = rightClickDelayTimerIn;
    }
