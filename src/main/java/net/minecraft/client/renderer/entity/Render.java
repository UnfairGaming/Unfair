...
import net.minecraft.rendering.optimization.entityculling.EntityRendererInter;
...
public abstract class Render<T extends Entity> implements IEntityRenderer, EntityRendererInter<T> {
    private static final ResourceLocation shadowTextures = ResourceLocation.of("textures/misc/shadow.png");
    @Getter
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
        ...
        if (d0 <= (double) (maxDistance * maxDistance)) {
            ...
            tessellator.draw();
            GlStateManager.enableTexture2D();
            fontrenderer.drawString(str, (float) -fontrenderer.getStringWidth(str) / 2, i, 553648127);
            GlStateManager.enableDepth();
            GlStateManager.depthMask(true);
            fontrenderer.drawString(str, (float) -fontrenderer.getStringWidth(str) / 2, i, -1);
            GlStateManager.enableLighting();
            GlStateManager.disableBlend();
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            GlStateManager.popMatrix();
