...
{
    private static final ResourceLocation GUARDIAN_TEXTURE = ResourceLocation.of("textures/entity/guardian.png");
    private static final ResourceLocation GUARDIAN_ELDER_TEXTURE = ResourceLocation.of("textures/entity/guardian_elder.png");
    private static final ResourceLocation GUARDIAN_BEAM_TEXTURE = ResourceLocation.of("textures/entity/guardian_beam.png");
    int field_177115_a;
