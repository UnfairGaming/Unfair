...
public class GuiWinGame extends GuiScreen {
    ...
    private static final ResourceLocation MINECRAFT_LOGO = ResourceLocation.of("textures/gui/title/minecraft.png");
    private static final ResourceLocation VIGNETTE_TEXTURE = ResourceLocation.of("textures/misc/vignette.png");
    ...
    public void initGui() {
        if (this.field_146582_i == null) {
            ...
            try {
                ...
                int i = 274;
                InputStream inputstream = this.mc.getResourceManager().getResource(ResourceLocation.of("texts/end.txt")).getInputStream();
                ...
                inputstream = this.mc.getResourceManager().getResource(ResourceLocation.of("texts/credits.txt")).getInputStream();
