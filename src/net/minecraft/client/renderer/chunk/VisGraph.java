...
public class VisGraph
{
    ...
    private boolean shouldForceAllVisible()
    {
        return Unfair.moduleManager != null
                && (Unfair.moduleManager.modules.get(Chams.class).isEnabled()
                || Unfair.moduleManager.modules.get(ViewClip.class).isEnabled()
                || Unfair.moduleManager.modules.get(Xray.class).isEnabled());
    }
