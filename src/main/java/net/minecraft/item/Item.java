...
public class Item
{
    ...
    {
        Item item = itemRegistry.getObject(ResourceLocation.of(id));
    ...
    {
        ResourceLocation resourceLocation = itemRegistry.getNameForObject(this);
    ...
    public static void registerItems()
    {
        ...
        registerItemBlock(Blocks.shulker_box);
        registerItemBlock(Blocks.white_shulker_box);
        registerItemBlock(Blocks.orange_shulker_box);
        registerItemBlock(Blocks.magenta_shulker_box);
        registerItemBlock(Blocks.light_blue_shulker_box);
        registerItemBlock(Blocks.yellow_shulker_box);
        registerItemBlock(Blocks.lime_shulker_box);
        registerItemBlock(Blocks.pink_shulker_box);
        registerItemBlock(Blocks.gray_shulker_box);
        registerItemBlock(Blocks.light_gray_shulker_box);
        registerItemBlock(Blocks.cyan_shulker_box);
        registerItemBlock(Blocks.purple_shulker_box);
        registerItemBlock(Blocks.blue_shulker_box);
        registerItemBlock(Blocks.brown_shulker_box);
        registerItemBlock(Blocks.green_shulker_box);
        registerItemBlock(Blocks.red_shulker_box);
        registerItemBlock(Blocks.black_shulker_box);
        registerItemBlock(Blocks.stonecutter);
        registerItemBlock(Blocks.composter);
        registerItemBlock(Blocks.lantern);
        registerItemBlock(Blocks.soul_lantern);
        registerItemBlock(Blocks.lectern);
        registerItemBlock(Blocks.grindstone);
        registerItemBlock(Blocks.bell);
        registerItemBlock(Blocks.chain);
        registerItemBlock(Blocks.bamboo);
        registerItemBlock(Blocks.tube_coral);
        registerItemBlock(Blocks.tube_coral_fan);
        ...
        for (String name : modernCorals) if (!name.contains("wall_fan")) registerItemBlock(Block.blockRegistry.getObject(net.minecraft.util.ResourceLocation.of(name)));
        registerItemBlock(Blocks.candle); registerItemBlock(Blocks.sculk_sensor); registerItemBlock(Blocks.big_dripleaf); registerItemBlock(Blocks.pointed_dripstone); registerItemBlock(Blocks.amethyst_cluster); registerItemBlock(Blocks.large_amethyst_bud); registerItemBlock(Blocks.medium_amethyst_bud); registerItemBlock(Blocks.small_amethyst_bud);
        registerItemBlock(Blocks.mud);registerItemBlock(Blocks.sculk_shrieker);registerItemBlock(Blocks.decorated_pot);registerItemBlock(Blocks.sniffer_egg);
    ...
    {
        registerItem(id, ResourceLocation.of(textualID), itemIn);
    }
