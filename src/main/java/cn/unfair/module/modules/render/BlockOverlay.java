...
public class BlockOverlay extends Module {
    ...
    public final ModeProperty renderMode = new ModeProperty("RenderMode", 1, new String[]{"Hidden", "Vanilla", "Side", "Full"});
    ...
    public final BooleanProperty hidePlants = new BooleanProperty("HidePlants", false);
    public final FloatProperty thickness = new FloatProperty("Thickness", 2.0F, 1.0F, 10.0F);
    public final BooleanProperty overlayVisible = new BooleanProperty("OverlayVisible", true);
    public final ModeProperty overlayColorMode = new ModeProperty("OverlayColorMode", 0, new String[]{"Static", "Gradient", "Fade", "Chroma"});
    public final ColorProperty overlayStaticColor = new ColorProperty("OverlayStaticColor", Color.WHITE.getRGB(), () -> this.overlayColorMode.getValue() == 0);
    public final PercentProperty overlayStaticOpacity = new PercentProperty("OverlayStaticOpacity", 100, () -> this.overlayColorMode.getValue() == 0);
    public final ColorProperty overlayGradientStartColor = new ColorProperty("OverlayGradientStartColor", Color.WHITE.getRGB(), () -> this.overlayColorMode.getValue() == 1);
    public final PercentProperty overlayGradientStartOpacity = new PercentProperty("OverlayGradientStartOpacity", 100, () -> this.overlayColorMode.getValue() == 1);
    public final ColorProperty overlayGradientEndColor = new ColorProperty("OverlayGradientEndColor", Color.WHITE.getRGB(), () -> this.overlayColorMode.getValue() == 1);
    public final PercentProperty overlayGradientEndOpacity = new PercentProperty("OverlayGradientEndOpacity", 100, () -> this.overlayColorMode.getValue() == 1);
    public final ColorProperty overlayFadeStartColor = new ColorProperty("OverlayFadeStartColor", Color.WHITE.getRGB(), () -> this.overlayColorMode.getValue() == 2);
    public final PercentProperty overlayFadeStartOpacity = new PercentProperty("OverlayFadeStartOpacity", 100, () -> this.overlayColorMode.getValue() == 2);
    public final ColorProperty overlayFadeEndColor = new ColorProperty("OverlayFadeEndColor", Color.WHITE.getRGB(), () -> this.overlayColorMode.getValue() == 2);
    public final PercentProperty overlayFadeEndOpacity = new PercentProperty("OverlayFadeEndOpacity", 100, () -> this.overlayColorMode.getValue() == 2);
    public final FloatProperty overlayFadeSpeed = new FloatProperty("OverlayFadeSpeed", 5.5F, 1.0F, 10.0F, () -> this.overlayColorMode.getValue() == 2);
    public final PercentProperty overlayChromaOpacity = new PercentProperty("OverlayChromaOpacity", 100, 7, 100, () -> this.overlayColorMode.getValue() == 3);
    public final FloatProperty overlayChromaSpeed = new FloatProperty("OverlayChromaSpeed", 5.5F, 1.0F, 10.0F, () -> this.overlayColorMode.getValue() == 3);
    public final BooleanProperty outlineVisible = new BooleanProperty("OutlineVisible", true);
    public final ModeProperty outlineColorMode = new ModeProperty("OutlineColorMode", 0, new String[]{"Static", "Gradient", "Fade", "Chroma"});
    public final ColorProperty outlineStaticColor = new ColorProperty("OutlineStaticColor", Color.BLACK.getRGB(), () -> this.outlineColorMode.getValue() == 0);
    public final PercentProperty outlineStaticOpacity = new PercentProperty("OutlineStaticOpacity", 100, () -> this.outlineColorMode.getValue() == 0);
    public final ColorProperty outlineGradientStartColor = new ColorProperty("OutlineGradientStartColor", Color.BLACK.getRGB(), () -> this.outlineColorMode.getValue() == 1);
    public final PercentProperty outlineGradientStartOpacity = new PercentProperty("OutlineGradientStartOpacity", 100, () -> this.outlineColorMode.getValue() == 1);
    public final ColorProperty outlineGradientEndColor = new ColorProperty("OutlineGradientEndColor", Color.BLACK.getRGB(), () -> this.outlineColorMode.getValue() == 1);
    public final PercentProperty outlineGradientEndOpacity = new PercentProperty("OutlineGradientEndOpacity", 100, () -> this.outlineColorMode.getValue() == 1);
    public final ColorProperty outlineFadeStartColor = new ColorProperty("OutlineFadeStartColor", Color.BLACK.getRGB(), () -> this.outlineColorMode.getValue() == 2);
    public final PercentProperty outlineFadeStartOpacity = new PercentProperty("OutlineFadeStartOpacity", 100, () -> this.outlineColorMode.getValue() == 2);
    public final ColorProperty outlineFadeEndColor = new ColorProperty("OutlineFadeEndColor", Color.BLACK.getRGB(), () -> this.outlineColorMode.getValue() == 2);
    public final PercentProperty outlineFadeEndOpacity = new PercentProperty("OutlineFadeEndOpacity", 100, () -> this.outlineColorMode.getValue() == 2);
    public final FloatProperty outlineFadeSpeed = new FloatProperty("OutlineFadeSpeed", 5.5F, 1.0F, 10.0F, () -> this.outlineColorMode.getValue() == 2);
    public final PercentProperty outlineChromaOpacity = new PercentProperty("OutlineChromaOpacity", 100, 7, 100, () -> this.outlineColorMode.getValue() == 3);
    public final FloatProperty outlineChromaSpeed = new FloatProperty("OutlineChromaSpeed", 5.5F, 1.0F, 10.0F, () -> this.outlineColorMode.getValue() == 3);
