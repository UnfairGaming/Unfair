...
public class TextureMap extends AbstractTexture implements ITickableTextureObject {
    public static final ResourceLocation LOCATION_MISSING_TEXTURE = ResourceLocation.of("missingno");
    public static final ResourceLocation locationBlocksTexture = ResourceLocation.of("textures/atlas/blocks.png");
        ...
        while (true) {
            if (iterator.hasNext()) {
                ...
                if (!this.skipFirst) {
                    ...
                    ResourceLocation resourcelocation1 = ResourceLocation.of(textureatlassprite3.getIconName());
    ...
    public ResourceLocation completeResourceLocation(ResourceLocation location, int p_147634_2_) {
        return this.isAbsoluteLocation(location) ? ResourceLocation.of(location.getResourceDomain(), location.getResourcePath() + ".png") : (p_147634_2_ == 0 ? ResourceLocation.of(location.getResourceDomain(), String.format("%s/%s%s", this.basePath, location.getResourcePath(), ".png")) : ResourceLocation.of(location.getResourceDomain(), String.format("%s/mipmaps/%s.%d%s", this.basePath, location.getResourcePath(), p_147634_2_, ".png")));
    }
    ...
    public TextureAtlasSprite getSpriteSafe(String p_getSpriteSafe_1_) {
        ResourceLocation resourcelocation = ResourceLocation.of(p_getSpriteSafe_1_);
    ...
    private int detectMinimumSpriteSize(Map<String, TextureAtlasSprite> p_detectMinimumSpriteSize_1_, IResourceManager p_detectMinimumSpriteSize_2_) {
        Map<Integer, Integer> map = new HashMap<>();

        for (Entry<String, TextureAtlasSprite> entry : p_detectMinimumSpriteSize_1_.entrySet()) {
            TextureAtlasSprite textureatlassprite = entry.getValue();
            ResourceLocation resourcelocation = ResourceLocation.of(textureatlassprite.getIconName());
    ...
    private void checkEmissive(ResourceLocation p_checkEmissive_1_, TextureAtlasSprite p_checkEmissive_2_) {
        ...
        if (s != null) {
            if (!p_checkEmissive_1_.getResourcePath().endsWith(s)) {
                ResourceLocation resourcelocation = ResourceLocation.of(p_checkEmissive_1_.getResourceDomain(), p_checkEmissive_1_.getResourcePath() + s);
                ResourceLocation resourcelocation1 = this.completeResourceLocation(resourcelocation);
