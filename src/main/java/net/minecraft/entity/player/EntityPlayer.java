...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public void setItemInUse(ItemStack itemInUseIn) {
        this.itemInUse = itemInUseIn;
    }
    ...
    public void setItemInUseCount(int itemInUseCountIn) {
        this.itemInUseCount = itemInUseCountIn;
    }
    ...
    public void onLivingUpdate() {
        ...
        double polarMotionX = this.getPolarVelocityMotionX();
        double polarMotionZ = this.getPolarVelocityMotionZ();
        float f = MathHelper.sqrt_double(polarMotionX * polarMotionX + polarMotionZ * polarMotionZ);
    ...
    private double getPolarVelocityMotionX() {
        return PolarVelocity.mode.getValue() == 0 ? this.motionX * 0.59928D : this.motionX;
    }

    private double getPolarVelocityMotionZ() {
        return PolarVelocity.mode.getValue() == 0 ? this.motionZ * 0.59928D : this.motionZ;
    }
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        if (i > 0) {
                            ...
                            if (!this.shouldKeepSprintingAfterAttack()) {
