...
public class ConnectedTextures
{
    ...
    public static void updateIcons(TextureMap textureMap)
    {
        ...
        if (Config.isConnectedTextures())
        {
            ...
            ResourceLocation resourcelocation = ResourceLocation.of("mcpatcher/ctm/default/empty");
    ...
    private static String[] getDefaultCtmPaths()
    {
        ...
        if (Config.isFromDefaultResourcePack(ResourceLocation.of("textures/blocks/glass.png")))
        {
            list.add(s + "glass.properties");
            list.add(s + "glasspane.properties");
        }

        if (Config.isFromDefaultResourcePack(ResourceLocation.of("textures/blocks/bookshelf.png")))
        {
            list.add(s + "bookshelf.properties");
        }

        if (Config.isFromDefaultResourcePack(ResourceLocation.of("textures/blocks/sandstone_normal.png")))
        {
        ...
        for (int i = 0; i < astring.length; ++i)
        {
            ...
            if (Config.isFromDefaultResourcePack(ResourceLocation.of("textures/blocks/glass_" + s1 + ".png")))
            {
