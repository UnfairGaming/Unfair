...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    private boolean isWorldUnavailable() {
        return this.gameController.theWorld == null || this.clientWorldController == null;
    }
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
        ...
        NetworkPlayerInfo networkplayerinfo = this.getPlayerInfo(packetIn.getPlayer());
        GameProfile gameprofile = networkplayerinfo == null ? new GameProfile(packetIn.getPlayer(), null) : networkplayerinfo.getGameProfile();
        EntityOtherPlayerMP entityotherplayermp = new EntityOtherPlayerMP(this.gameController.theWorld, gameprofile);
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        if (this.isWorldUnavailable() || this.gameController.thePlayer == null) {
            return;
        }
    ...
    private void consumeOffhandTotemIfActive(ItemStack activeTotem) {
        ...
        --offhand.stackSize;
        this.gameController.thePlayer.inventory.setOffhand(offhand.stackSize > 0 ? offhand : null);
    }
    ...
    public void handleSetSlot(S2FPacketSetSlot packetIn) {
        ...
        if (packetIn.func_149175_c() == -1) {
            ...
            entityplayer.inventory.setOffhand(packetIn.func_149174_e());
        } else {
            boolean flag = false;
        ...
        if (ModernOffhandInteraction.isModernTarget()
            ...
            if (mainHandUpdate || offhandUpdate) {
                this.gameController.thePlayer.confirmServerItemUseFinished();
            }
        }
    }
    ...
    public void handleWindowItems(S30PacketWindowItems packetIn) {
        ...
        if (packetIn.func_148911_c() == 0) {
            ...
            if (ModernOffhandInteraction.isModernTarget() && packetIn.getItemStacks().length > 45) {
                entityplayer.inventory.setOffhand(packetIn.getItemStacks()[45]);
            }
    ...
    public void handleEntityEquipment(S04PacketEntityEquipment packetIn) {
        ...
        if (entity instanceof EntityPlayer
            ...
            ((EntityPlayer) entity).inventory.setOffhand(packetIn.getItemStack());
        } else if (entity != null) {
