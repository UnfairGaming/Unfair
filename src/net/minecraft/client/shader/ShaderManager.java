...
public class ShaderManager
{
    ...
    {
        ResourceLocation resourcelocation = ResourceLocation.of("shaders/program/" + programName + ".json");
        ...
        try
        {
            ...
            JsonObject jsonobject = com.google.gson.JsonParser.parseString(IOUtils.toString(inputstream, Charsets.UTF_8)).getAsJsonObject();
