...
public class BlockModernLantern extends BlockModernShape {
    ...
    public BlockModernLantern(ProtocolVersion protocol, int firstState, int lastState) {
        super(Material.iron, protocol, firstState, lastState, new double[]{5, 0, 5, 11, 7, 11}, new double[]{6, 7, 6, 10, 9, 10});
    ...
    public IBlockState getStateFromViaStateId(int id) {
        return getDefaultState().withProperty(HANGING, ((id - firstState) & 1) != 0);
    }
}
