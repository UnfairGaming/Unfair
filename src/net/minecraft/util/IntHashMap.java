...
{
    private transient IntHashMap.Entry<V>[] slots = createEntryArray(16);
    ...
    private void grow(int p_76047_1_)
    {
        ...
        {
            IntHashMap.Entry<V>[] entry1 = createEntryArray(p_76047_1_);
            this.copyTo(entry1);
            this.slots = entry1;
    ...
    private static <V> IntHashMap.Entry<V>[] createEntryArray(int size)
    {
        return (IntHashMap.Entry<V>[])new IntHashMap.Entry[size];
    }
}
