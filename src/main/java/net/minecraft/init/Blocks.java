...
public class Blocks
{
    ...
    static
    {
        ...
        else
        {
            ...
            stonecutter = getRegisteredBlock("stonecutter");
            composter = getRegisteredBlock("composter");
            lantern = getRegisteredBlock("lantern");
            soul_lantern = getRegisteredBlock("soul_lantern");
            lectern = getRegisteredBlock("lectern");
            grindstone = getRegisteredBlock("grindstone");
            bell = getRegisteredBlock("bell");
            chain = getRegisteredBlock("chain");
            ...
            candle_cake = getRegisteredBlock("candle_cake");
            sculk_sensor = getRegisteredBlock("sculk_sensor");
            big_dripleaf = getRegisteredBlock("big_dripleaf");
            pointed_dripstone = getRegisteredBlock("pointed_dripstone");
            amethyst_cluster = getRegisteredBlock("amethyst_cluster");
            small_amethyst_bud = getRegisteredBlock("small_amethyst_bud");
            medium_amethyst_bud = getRegisteredBlock("medium_amethyst_bud");
            large_amethyst_bud = getRegisteredBlock("large_amethyst_bud");
            mud = getRegisteredBlock("mud"); decorated_pot = getRegisteredBlock("decorated_pot"); sniffer_egg = getRegisteredBlock("sniffer_egg"); sculk_shrieker = getRegisteredBlock("sculk_shrieker");
        }
    }
}
