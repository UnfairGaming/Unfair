...
public class TileEntityRendererDispatcher {
    ...
    public <T extends TileEntity> TileEntitySpecialRenderer<T> getSpecialRendererByClass(Class<? extends TileEntity> teClass) {
        ...
        if (tileentityspecialrenderer == null && teClass != TileEntity.class) {
            Class<?> superclass = teClass.getSuperclass();
            if (superclass != null && TileEntity.class.isAssignableFrom(superclass)) {
                tileentityspecialrenderer = this.getSpecialRendererByClass(superclass.asSubclass(TileEntity.class));
            }
            this.mapSpecialRenderers.put(teClass, tileentityspecialrenderer);
        }

        return castSpecialRenderer(tileentityspecialrenderer);
    }
    ...
    public void renderTileEntityAt(TileEntity tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        EntityCullingManager.instance.renderedBlockEntities++;
