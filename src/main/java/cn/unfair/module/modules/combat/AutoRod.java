...
public class AutoRod extends Module {
    ...
    public final FloatProperty minRange = new FloatProperty("MinRange", 3.2F, 1.0F, 8.0F);
    public final FloatProperty maxRange = new FloatProperty("MaxRange", 4.5F, 1.0F, 8.0F);
    public final IntProperty useDelayOnSwitch = new IntProperty("UseDelayOnSwitch", 1, 0, 10);
    public final IntProperty maxWaitDelay = new IntProperty("MaxWaitDelay", 2, 0, 20);
    public final IntProperty maxRecastDelay = new IntProperty("MaxRecastDelay", 1, 0, 20);
    public final IntProperty switchBackDelay = new IntProperty("SwitchbackDelay", 3, 0, 10);
    ...
    public final FloatProperty basePrediction = new FloatProperty("BasePrediction", 2.0F, 0.0F, 8.0F, this.rotate::getValue);
    public final BooleanProperty onlyOnKillAura = new BooleanProperty("OnlyOnKillAura", false);
    public final BooleanProperty overrideAuraRots = new BooleanProperty("OverrideKillAuraRots", true);
