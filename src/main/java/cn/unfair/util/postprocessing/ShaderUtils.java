...
public class ShaderUtils {
    ...
    public static void drawFixedQuads() {
        ...
        float width = (float) (net.minecraft.client.Minecraft.getMinecraft().displayWidth / factor);
        float height = (float) (net.minecraft.client.Minecraft.getMinecraft().displayHeight / factor);
