...
public class KillAura extends Module {
    ...
    public final ModeProperty autoBlock = new ModeProperty(
            "AutoBlock", 0, new String[]{"None", "Vanilla", "Legit", "Fake", "HypixelLagA", "HypixelLagB"}
    );
    public final BooleanProperty autoBlockRequirePress = new BooleanProperty("AutoBlockRequirePress", false);
    public final IntProperty autoBlockCPS = new IntProperty("AutoBlockAps", 10, 1, 20);
    public final FloatProperty autoBlockRange = new FloatProperty("AutoBlockRange", 6.0F, 3.0F, 8.0F);
    public final FloatProperty swingRange = new FloatProperty("SwingRange", 3.5F, 3.0F, 6.0F);
    public final FloatProperty attackRange = new FloatProperty("AttackRange", 3.0F, 3.0F, 6.0F);
    public final IntProperty fov = new IntProperty("Fov", 360, 30, 360);
    public final IntProperty minCPS = new IntProperty("MinAps", 14, 1, 20);
    public final IntProperty maxCPS = new IntProperty("MaxAps", 14, 1, 20);
    public final IntProperty switchDelay = new IntProperty("SwitchDelay", 150, 0, 1000);
    public final ModeProperty rotations = new ModeProperty("Rotations", 2, new String[]{"None", "Legit", "Silent", "Simulation", "Grim"});
    public final BooleanProperty lockView = new BooleanProperty("LockView", false, () -> this.rotations.getValue() == 2 || this.rotations.getValue() == 3);
    public final ModeProperty moveFix = new ModeProperty("MoveFix", 1, new String[]{"None", "Silent", "Strict"}, () -> this.rotations.getValue() == 2 || this.rotations.getValue() == 3);
    ...
    public final PercentProperty minYawMultiplierOnLimit = new PercentProperty("MinYawMultiplierOnLimit", 10, () -> this.rotations.getValue() == 3 && this.averageYawLimiterMode.getValue() == 1 && this.maxDeltaHistorySize.getValue() > 0);
    public final PercentProperty maxYawMultiplierOnLimit = new PercentProperty("MaxYawMultiplierOnLimit", 100, () -> this.rotations.getValue() == 3 && this.averageYawLimiterMode.getValue() == 1 && this.maxDeltaHistorySize.getValue() > 0);
    public final FloatProperty hitboxQuality = new FloatProperty("HitboxQuality", 1.0F, 0.01F, 1.0F, () -> this.rotations.getValue() == 3);
    public final FloatProperty outOfRangeBuffer = new FloatProperty("OutOfRangeBuffer", 0.0F, -1.0F, 1.0F, () -> this.rotations.getValue() == 3);
    public final ModeProperty preferredBodyPart = new ModeProperty("PreferredBodyPart", 0, new String[]{"None", "Head", "Torso", "Feet"}, () -> this.rotations.getValue() == 3);
    public final BooleanProperty blacklistHead = new BooleanProperty("BlacklistHead", false, () -> this.rotations.getValue() == 3);
    public final BooleanProperty blacklistTorso = new BooleanProperty("BlacklistTorso", false, () -> this.rotations.getValue() == 3);
    public final BooleanProperty blacklistFeet = new BooleanProperty("BlacklistFeet", false, () -> this.rotations.getValue() == 3);
    public final BooleanProperty blacklistBadHitVec = new BooleanProperty("BlacklistBadHitvec", false, () -> this.rotations.getValue() == 3);
    public final FloatProperty badHitVecBuffer = new FloatProperty("BadHitvecBuffer", 0.5F, 0.01F, 2.0F, () -> this.rotations.getValue() == 3 && this.blacklistBadHitVec.getValue());
    public final BooleanProperty blacklistHeuristic = new BooleanProperty("BlacklistHeuristic", false, () -> this.rotations.getValue() == 3);
    public final FloatProperty heuristicBuffer = new FloatProperty("HeuristicBuffer", 0.1F, 0.01F, 2.0F, () -> this.rotations.getValue() == 3 && this.blacklistHeuristic.getValue());
    public final BooleanProperty dynamicTrim = new BooleanProperty("DynamicTrim", false, () -> this.rotations.getValue() == 3);
    public final FloatProperty yTrim = new FloatProperty("YTrim", 0.0F, 0.0F, 0.5F, () -> this.rotations.getValue() == 3 && !this.dynamicTrim.getValue());
    public final FloatProperty xzRandAdd = new FloatProperty("XzRandAdd", 0.0F, 0.0F, 0.5F, () -> this.rotations.getValue() == 3 && this.dynamicTrim.getValue());
    public final FloatProperty xzTrim = new FloatProperty("XzTrim", 0.0F, 0.0F, 0.5F, () -> this.rotations.getValue() == 3);
    public final BooleanProperty predictionEngine = new BooleanProperty("PredictionEngine", false, () -> this.rotations.getValue() == 3);
    public final BooleanProperty simulateReactionTime = new BooleanProperty("SimulateReactionTime", false, () -> this.rotations.getValue() == 3 && this.predictionEngine.getValue());
    public final IntProperty minReactionTime = new IntProperty("MinReactionTime", 0, 0, 20, () -> this.rotations.getValue() == 3 && this.predictionEngine.getValue() && this.simulateReactionTime.getValue());
    public final IntProperty maxReactionTime = new IntProperty("MaxReactionTime", 10, 0, 20, () -> this.rotations.getValue() == 3 && this.predictionEngine.getValue() && this.simulateReactionTime.getValue());
    public final FloatProperty thresholdToApplyReactionTime = new FloatProperty("ThresholdToApplyReactionTime", 0.1F, 0.01F, 1.0F, () -> this.rotations.getValue() == 3 && this.predictionEngine.getValue() && this.simulateReactionTime.getValue());
    public final FloatProperty thresholdForDirectionConfidence = new FloatProperty("ThresholdForDirectionConfidence", 0.1F, 0.01F, 0.5F, () -> this.rotations.getValue() == 3 && this.predictionEngine.getValue() && this.simulateReactionTime.getValue());
    public final PercentProperty extraPrediction = new PercentProperty("ExtraReactionPrediction", 100, () -> this.rotations.getValue() == 3 && this.predictionEngine.getValue() && this.simulateReactionTime.getValue());
    public final BooleanProperty jitter = new BooleanProperty("Jitter", false, () -> this.rotations.getValue() == 3);
    public final PercentProperty minJitterFactor = new PercentProperty("MinJitterFactor", 50, () -> this.rotations.getValue() == 3 && this.jitter.getValue());
    public final PercentProperty maxJitterFactor = new PercentProperty("MaxJitterFactor", 50, () -> this.rotations.getValue() == 3 && this.jitter.getValue());
    public final BooleanProperty interpolateJitterVec = new BooleanProperty("InterpolateJitterVec", false, () -> this.rotations.getValue() == 3 && this.jitter.getValue());
    public final ModeProperty lookVec = new ModeProperty("LookVec", 2, new String[]{"Client", "Server", "Normalised"}, () -> this.rotations.getValue() == 3);
    public final ModeProperty offsetMode = new ModeProperty("OffsetMode", 0, new String[]{"None", "Gaussian", "Noise", "Advanced"}, () -> this.rotations.getValue() == 3);
    public final ModeProperty advancedBase = new ModeProperty("AdvancedBase", 0, new String[]{"Gaussian", "Noise"}, () -> this.rotations.getValue() == 3 && this.offsetMode.getValue() == 3);
    public final IntProperty offsetChance = new IntProperty("OffsetChance", 75, 1, 100, () -> this.rotations.getValue() == 3 && this.offsetMode.getValue() != 0);
    public final PercentProperty minYawFactor = new PercentProperty("MinYawFactor", 25, () -> this.rotations.getValue() == 3 && this.offsetMode.getValue() != 0);
    public final PercentProperty maxYawFactor = new PercentProperty("MaxYawFactor", 25, () -> this.rotations.getValue() == 3 && this.offsetMode.getValue() != 0);
    public final PercentProperty minPitchFactor = new PercentProperty("MinPitchFactor", 25, () -> this.rotations.getValue() == 3 && this.offsetMode.getValue() != 0);
    public final PercentProperty maxPitchFactor = new PercentProperty("MaxPitchFactor", 25, () -> this.rotations.getValue() == 3 && this.offsetMode.getValue() != 0);
    public final BooleanProperty interpolateVec = new BooleanProperty("InterpolateVec", false, () -> this.rotations.getValue() == 3 && this.offsetMode.getValue() != 0);
    public final PercentProperty offsetAmount = new PercentProperty("OffsetAmount", 50, () -> this.rotations.getValue() == 3 && this.offsetMode.getValue() != 0 && this.interpolateVec.getValue());
    public final FloatProperty advancedTolerance = new FloatProperty("AdvancedTolerance", 0.05F, 0.01F, 0.1F, () -> this.rotations.getValue() == 3 && this.offsetMode.getValue() == 3);
    ...
    public final BooleanProperty allowMining = new BooleanProperty("AllowMining", false);
    ...
    public final ModeProperty showTarget = new ModeProperty("ShowTarget", 0, new String[]{"None", "3Dbox"});
    private final BooleanProperty alwaysRenderBlocking = new BooleanProperty(
            "AlwaysRenderBlocking", true, () -> this.autoBlock.getValue() == 4 || this.autoBlock.getValue() == 5
    );
    private final BooleanProperty c09Instead = new BooleanProperty(
            "C09Instead", true, () -> this.autoBlock.getValue() == 4
    );
    private final BooleanProperty fullC09 = new BooleanProperty(
            "FullC09(WillCauseDamageLess)", false, () -> this.autoBlock.getValue() == 5
    );
    ...
    public boolean isHypixelLagAutoBlockActive() {
        return this.isEnabled() && this.isHypixelLagAutoBlock();
    }

    public int getAutoBlockTick() {
        return this.blockTick;
    }

    private long getAttackDelay() {
        KeepSprint keepSprint = (KeepSprint) Unfair.moduleManager.modules.get(KeepSprint.class);
        long keepSprintDelay = keepSprint.getOldPredictionAttackDelay();
        if (keepSprintDelay != Long.MIN_VALUE) {
            return keepSprintDelay;
        }
    ...
    private boolean isValidTarget(EntityLivingBase entityLivingBase) {
        if (!mc.theWorld.loadedEntityList.contains(entityLivingBase)) {
            ...
            if (entityLivingBase == mc.getRenderViewEntity() || entityLivingBase == mc.getRenderViewEntity().ridingEntity) {
                ...
                return false;
            } else if (!this.throughWalls.getValue() && !this.hasVisibleAimPoint(entityLivingBase)) {
                return false;
    ...
    private boolean hasVisibleAimPoint(EntityLivingBase entityLivingBase) {
        AxisAlignedBB box = entityLivingBase.getEntityBoundingBox().expand(
                entityLivingBase.getCollisionBorderSize(),
                entityLivingBase.getCollisionBorderSize(),
                entityLivingBase.getCollisionBorderSize()
        );
        double preferredY = this.getPreferredAimY(entityLivingBase, box);
        return RotationUtil.getBestAimPoint(
                entityLivingBase,
                box,
                mc.thePlayer.getPositionEyes(1.0F),
                preferredY,
                Math.max(this.swingRange.getValue(), this.autoBlockRange.getValue()),
                1.0D,
                0.0D,
                false,
                true
    ...
    private double getPreferredAimY(EntityLivingBase entityLivingBase, AxisAlignedBB box) {
        double heightDifference = entityLivingBase.posY - mc.thePlayer.posY;
        double heightFactor = 0.75D - MathHelper.clamp_double(heightDifference / 4.0D, 0.0D, 0.65D);
        return box.minY + (box.maxY - box.minY) * heightFactor;
    }
