...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    private static final ResourceLocation creativeInventoryTabs = ResourceLocation.of("textures/gui/container/creative_inventory/tabs.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.mc.getTextureManager().bindTexture(ResourceLocation.of("textures/gui/container/creative_inventory/tab_" + creativetabs.getBackgroundImageName()));
