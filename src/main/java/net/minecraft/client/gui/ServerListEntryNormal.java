...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    private static final ResourceLocation UNKNOWN_SERVER = ResourceLocation.of("textures/misc/unknown_server.png");
    private static final ResourceLocation SERVER_SELECTION_BUTTONS = ResourceLocation.of("textures/gui/server_selection.png");
    ...
    protected ServerListEntryNormal(GuiMultiplayer p_i45048_1_, ServerData serverIn)
    {
        ...
        this.serverIcon = ResourceLocation.of("servers/" + serverIn.serverIP + "/icon");
