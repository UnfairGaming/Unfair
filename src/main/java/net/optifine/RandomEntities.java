...
public class RandomEntities {
    ...
    private static ResourceLocation getLocationProperties(ResourceLocation loc, boolean mcpatcher) {
        ...
        if (resourcelocation == null) {
            ...
            ResourceLocation resourcelocation1 = ResourceLocation.of(s, s3);
            ...
            if (Config.hasResource(resourcelocation1)) {
                ...
                if (s4 == null) {
                    ...
                    ResourceLocation resourcelocation2 = ResourceLocation.of(s, s4 + ".properties");
    ...
    protected static ResourceLocation getLocationRandom(ResourceLocation loc, boolean mcpatcher) {
        ...
        if (!s1.startsWith(s2)) {
            ...
            return ResourceLocation.of(s, s4);
        }
    }
    ...
    protected static ResourceLocation getLocationIndexed(ResourceLocation loc, int index) {
        if (loc == null) {
            ...
            if (i < 0) {
                ...
                ResourceLocation resourcelocation = ResourceLocation.of(loc.getResourceDomain(), s3);
    ...
    private static void initialize() {
        ...
        for (int i = 0; i < astring2.length; ++i) {
            ...
            if (!set.contains(s1)) {
                set.add(s1);
                ResourceLocation resourcelocation = ResourceLocation.of(s1);
