...
public class SmartLeaves
{
    ...
    static IBakedModel getModelCull(String type, List updatedTypes)
    {
        ...
        {
            ResourceLocation resourcelocation = ResourceLocation.of("blockstates/" + type + "_leaves.json");
            ...
            {
                ResourceLocation resourcelocation1 = ResourceLocation.of("models/block/" + type + "_leaves.json");
