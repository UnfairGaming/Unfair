...
public class FontUtils
{
    public static Properties readFontProperties(ResourceLocation locationFontTexture)
    {
        ...
        else
        {
            ...
            try
            {
                ResourceLocation resourcelocation = ResourceLocation.of(locationFontTexture.getResourceDomain(), s2);
    ...
    public static ResourceLocation getHdFontLocation(ResourceLocation fontLoc)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                s = s2 + s;
                ResourceLocation resourcelocation = ResourceLocation.of(fontLoc.getResourceDomain(), s);
