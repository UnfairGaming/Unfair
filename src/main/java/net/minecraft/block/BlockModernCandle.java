...
public class BlockModernCandle extends ModernBlock {
    ...
    private AxisAlignedBB getCandleCollisionBox(BlockPos pos, IBlockState state) {
        ...
        switch (candles) {
            case 1:
                minX = 7.0D; minZ = 7.0D; maxX = 9.0D; maxZ = 9.0D;
                break;
            case 2:
                minX = 5.0D; minZ = 6.0D; maxX = 11.0D; maxZ = 9.0D;
                break;
            case 3:
                minX = 5.0D; minZ = 6.0D; maxX = 10.0D; maxZ = 11.0D;
                break;
            default:
                minX = 5.0D; minZ = 5.0D; maxX = 11.0D; maxZ = 10.0D;
                break;
        }
