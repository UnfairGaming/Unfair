...
{
    private static final ResourceLocation field_175267_f = ResourceLocation.of("textures/gui/widgets.png");
    public static final ResourceLocation field_175269_a = ResourceLocation.of("textures/gui/spectator_widgets.png");
