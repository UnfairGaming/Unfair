...
public class ChestAura extends Module {
    ...
    public final FloatProperty openDelay = new FloatProperty("OpenDelay", 100.0F, 0.0F, 600.0F);
    public final BooleanProperty interactOnce = new BooleanProperty("InteractOnce", true);
