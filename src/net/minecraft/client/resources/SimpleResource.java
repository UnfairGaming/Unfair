...
public class SimpleResource implements IResource {
    ...
    public SimpleResource(String resourcePackNameIn, ResourceLocation srResourceLocationIn, InputStream resourceInputStreamIn, Supplier<InputStream> mcmetaInputStreamIn, IMetadataSerializer srMetadataSerializerIn) {
