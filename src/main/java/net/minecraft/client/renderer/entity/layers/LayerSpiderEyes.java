...
public class LayerSpiderEyes implements LayerRenderer<EntitySpider> {
    private static final ResourceLocation SPIDER_EYES = ResourceLocation.of("textures/entity/spider_eyes.png");
    private final RenderSpider<EntitySpider> spiderRenderer;

    @SuppressWarnings("unchecked")
    public LayerSpiderEyes(RenderSpider<? extends EntitySpider> spiderRendererIn) {
        this.spiderRenderer = (RenderSpider<EntitySpider>) spiderRendererIn;
    }
