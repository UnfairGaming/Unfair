...
public class TextureManager implements ITickable, IResourceManagerReloadListener {
    ...
    public final Map<ResourceLocation, ITextureObject> mapTextureObjects = new ConcurrentHashMap<>();
    ...
    public ResourceLocation getDynamicTextureLocation(String name, DynamicTexture texture) {
        ...
        ResourceLocation resourcelocation = ResourceLocation.of(String.format("dynamic/%s_%d", name, integer));
