...
public class TargetESP extends Module {
    ...
    private final ModeProperty colorMode = new ModeProperty("ColorMode", 0, new String[]{"Hud", "Custom", "Fade"});
    private final ColorProperty customColor = new ColorProperty("CustomColor", Color.WHITE.getRGB(), () -> colorMode.getValue() == 1);
    private final ColorProperty fadeColor1 = new ColorProperty("FadeColor1", Color.WHITE.getRGB(), () -> colorMode.getValue() == 2);
    private final ColorProperty fadeColor2 = new ColorProperty("FadeColor2", Color.WHITE.getRGB(), () -> colorMode.getValue() == 2);
    private final ModeProperty mode = new ModeProperty("MarkMode", 1, new String[]{"Points", "Ghost", "Ghost2", "Image", "Exhi", "Circle"});
    private final ModeProperty imageMode = new ModeProperty("ImageMode", 0, new String[]{"Rectangle", "QuadStapple", "TriangleStapple", "TriangleStipple", "Aim"}, () -> mode.getValue() == 3);
