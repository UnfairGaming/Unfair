...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    private static final ResourceLocation locationRainPng = ResourceLocation.of("textures/environment/rain.png");
    private static final ResourceLocation locationSnowPng = ResourceLocation.of("textures/environment/snow.png");
    ...
    private static final ResourceLocation[] shaderResourceLocations = new ResourceLocation[]{ResourceLocation.of("shaders/post/notch.json"), ResourceLocation.of("shaders/post/fxaa.json"), ResourceLocation.of("shaders/post/art.json"), ResourceLocation.of("shaders/post/bumpy.json"), ResourceLocation.of("shaders/post/blobs2.json"), ResourceLocation.of("shaders/post/pencil.json"), ResourceLocation.of("shaders/post/color_convolve.json"), ResourceLocation.of("shaders/post/deconverge.json"), ResourceLocation.of("shaders/post/flip.json"), ResourceLocation.of("shaders/post/invert.json"), ResourceLocation.of("shaders/post/ntsc.json"), ResourceLocation.of("shaders/post/outline.json"), ResourceLocation.of("shaders/post/phosphor.json"), ResourceLocation.of("shaders/post/scan_pincushion.json"), ResourceLocation.of("shaders/post/sobel.json"), ResourceLocation.of("shaders/post/bits.json"), ResourceLocation.of("shaders/post/desaturate.json"), ResourceLocation.of("shaders/post/green.json"), ResourceLocation.of("shaders/post/blur.json"), ResourceLocation.of("shaders/post/wobble.json"), ResourceLocation.of("shaders/post/blobs.json"), ResourceLocation.of("shaders/post/antialias.json"), ResourceLocation.of("shaders/post/creeper.json"), ResourceLocation.of("shaders/post/spider.json")};
    ...
    public void loadEntityShader(Entity entityIn) {
        if (OpenGlHelper.shadersSupported) {
            ...
            if (entityIn instanceof EntityCreeper) {
                this.loadShader(ResourceLocation.of("shaders/post/creeper.json"));
            } else if (entityIn instanceof EntitySpider) {
                this.loadShader(ResourceLocation.of("shaders/post/spider.json"));
            } else if (entityIn instanceof EntityEnderman) {
                this.loadShader(ResourceLocation.of("shaders/post/invert.json"));
            }
        }
    }
    ...
    public void updateRenderer() {
        this.applyRenderItemSpoofing(false);
        ...
        this.restoreRenderItemSpoofing(false);
    }

    private void applyRenderItemSpoofing(boolean includeBlocking) {
        if (this.mc.thePlayer == null || Unfair.moduleManager == null) {
            return;
        }
        ...
        if (slot >= 0) {
            this.unfairSpoofedSlot = this.mc.thePlayer.inventory.currentItem;
    ...
    private void restoreRenderItemSpoofing(boolean includeBlocking) {
        if (this.mc.thePlayer == null) {
            return;
        }

        if (this.unfairSpoofedSlot != null) {
            this.mc.thePlayer.inventory.currentItem = this.unfairSpoofedSlot;
            this.unfairSpoofedSlot = null;
        }
        ...
        if (includeBlocking) {
            ...
            if (this.unfairSavedItemInUseCount != null) {
                this.mc.thePlayer.setItemInUseCount(this.unfairSavedItemInUseCount);
                this.unfairSavedItemInUseCount = null;
            }
        }
    }
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && mc.theWorld != null) {
            ...
            RaytraceEvent raytraceEvent = new RaytraceEvent(blockReachDistance);
            EventManager.call(raytraceEvent);
            blockReachDistance = raytraceEvent.getRange();

            PickEvent pickEvent = new PickEvent(3.0D);
            EventManager.call(pickEvent);
            double reach = pickEvent.getRange();
            float expand = 0;
            ...
            if (Unfair.moduleManager != null) {
                GhostHand ghostHand = (GhostHand) Unfair.moduleManager.modules.get(GhostHand.class);
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase entitylivingbase) {
            ...
            float hurtAmount = 14.0F;

            if (Unfair.moduleManager != null) {
                NoHurtCam noHurtCam = (NoHurtCam) Unfair.moduleManager.modules.get(NoHurtCam.class);

                if (noHurtCam.isEnabled()) {
                    hurtAmount *= (float) noHurtCam.multiplier.getValue() / 100.0F;
                }
            }

            GlStateManager.rotate(-f2, 0.0F, 1.0F, 0.0F);
            GlStateManager.rotate(-f * hurtAmount, 0.0F, 0.0F, 1.0F);
            GlStateManager.rotate(f2, 0.0F, 1.0F, 0.0F);
        }
    }
    ...
    public void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                GlStateManager.rotate(this.getInterpolatedCameraYaw(entity, partialTicks) + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(this.getInterpolatedCameraPitch(entity, partialTicks), -1.0F, 0.0F, 0.0F);
            }
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                float f1 = this.getCameraYaw(entity);
                float f2 = this.getCameraPitch(entity);

                if (this.mc.gameSettings.thirdPersonView == 2) {
                    f2 += 180.0F;
                }

                boolean viewClipEnabled = this.isViewClipEnabled();
                if (viewClipEnabled) {
                    d3 = 4.0D;
                }
                ...
                GlStateManager.rotate(this.getCameraPitch(entity) - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(this.getCameraYaw(entity) - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float) (-d3));
                GlStateManager.rotate(f1 - this.getCameraYaw(entity), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - this.getCameraPitch(entity), 1.0F, 0.0F, 0.0F);
            }
        } else {
    ...
    private float getCameraYaw(Entity entity) {
        return FreeLook.INSTANCE != null && FreeLook.INSTANCE.isActive() ? FreeLook.INSTANCE.cameraYaw : entity.rotationYaw;
    }

    private float getCameraPitch(Entity entity) {
        return FreeLook.INSTANCE != null && FreeLook.INSTANCE.isActive() ? FreeLook.INSTANCE.cameraPitch : entity.rotationPitch;
    }

    private float getInterpolatedCameraYaw(Entity entity, float partialTicks) {
        if (FreeLook.INSTANCE != null && FreeLook.INSTANCE.isActive()) {
            return FreeLook.INSTANCE.prevCameraYaw + (FreeLook.INSTANCE.cameraYaw - FreeLook.INSTANCE.prevCameraYaw) * partialTicks;
        }

        return entity.prevRotationYaw + (entity.rotationYaw - entity.prevRotationYaw) * partialTicks;
    }

    private float getInterpolatedCameraPitch(Entity entity, float partialTicks) {
        if (FreeLook.INSTANCE != null && FreeLook.INSTANCE.isActive()) {
            return FreeLook.INSTANCE.prevCameraPitch + (FreeLook.INSTANCE.cameraPitch - FreeLook.INSTANCE.prevCameraPitch) * partialTicks;
        }

        return entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks;
    }

    private boolean isPotionActiveForRendering(EntityLivingBase entity, Potion potion) {
        if (Unfair.moduleManager != null) {
            AntiDebuff antiDebuff = (AntiDebuff) Unfair.moduleManager.modules.get(AntiDebuff.class);

            if (antiDebuff.isEnabled()) {
                if (potion == Potion.blindness && antiDebuff.blindness.getValue()) {
                    return false;
                }

                if (potion == Potion.confusion && antiDebuff.nausea.getValue()) {
                    return false;
                }
            }
        }

        return entity.getActivePotionsMap().containsKey(potion.id);
    }

    private Material getCameraBlockMaterial(Block block) {
        return this.isViewClipEnabled() ? Material.air : block.getMaterial();
    }

    private boolean isViewClipEnabled() {
        return Unfair.moduleManager != null
                && Unfair.moduleManager.modules.get(ViewClip.class) instanceof ViewClip viewClip
                && viewClip.isEnabled();
    }
    ...
    public void setupCameraTransform(float partialTicks, int pass) {
        ...
        if (f1 > 0.0F) {
            ...
            if (this.isPotionActiveForRendering(this.mc.thePlayer, Potion.confusion)) {
                i = 7;
            }
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        this.applyRenderItemSpoofing(true);
        this.frameInit();
        ...
        this.restoreRenderItemSpoofing(true);
    }
    ...
    private void updateFogColor(float partialTicks) {
        ...
        } else if (this.getCameraBlockMaterial(block) == Material.water) {
        ...
        } else if (this.getCameraBlockMaterial(block) == Material.lava) {
        ...
        if (entity instanceof EntityLivingBase && this.isPotionActiveForRendering((EntityLivingBase) entity, Potion.blindness)) {
    ...
    public boolean setFxaaShader(int p_setFxaaShader_1_) {
        if (!OpenGlHelper.isFramebufferEnabled()) {
            ...
            this.loadShader(ResourceLocation.of("shaders/post/fxaa_of_" + p_setFxaaShader_1_ + "x.json"));
