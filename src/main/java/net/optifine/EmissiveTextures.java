...
public class EmissiveTextures
{
    ...
    private static final ResourceLocation LOCATION_EMPTY = ResourceLocation.of("mcpatcher/ctm/default/empty.png");
            ...
            if (suffixEmissivePng != null)
            {
                ...
                if (s.endsWith(".png"))
                {
                    ...
                    else
                    {
                        ...
                        ResourceLocation resourcelocation = ResourceLocation.of(loc.getResourceDomain(), s1);
